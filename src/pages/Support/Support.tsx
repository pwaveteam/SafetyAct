...
const fields: Field[] = [
{ label: "문의유형", name: "type", type: "select", placeholder: "문의유형 선택", options: [ { value: "기술문의", label: "기술문의" }, { value: "서비스문의", label: "서비스문의" }, { value: "기타문의", label: "기타문의" } ] },
...
{ label: "답변 받을 이메일", name: "email", type: "email", placeholder: "이메일 입력" }
]
