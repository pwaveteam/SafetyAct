...
<Button variant="clear" onClick={handleClose}>닫기</Button>
{step === 1 && <Button variant="primary" onClick={handleNext}>다음으로</Button>}
{step === 2 && (<><Button variant="clear" onClick={handleBack}>이전</Button><Button variant="primary" onClick={handleConfirm} disabled={!selectedProcess}>확인</Button></>)}
</div>
</div>
</div>
)
