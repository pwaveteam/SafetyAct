...
setData(prev => prev.map((r, i) => i === idx ? { ...r, afterPhoto: url } : r))
}
...
<Button variant="step" onClick={() => navigate("/risk-assessment/methods/threestep/step1")}><ChevronLeft size={18} className="mr-2" />이전으로</Button>
<Button variant="step" onClick={() => navigate("/risk-assessment/methods/threestep/step3")}>저장 후 다음으로<ChevronRight size={18} className="ml-2" /></Button>
</div>
</section>
)
}
