...
<Button variant="docs" className="min-w-[100px] h-[30px] text-xs gap-1" onClick={() => handleDownloadExample(section.downloadKey!)}>
...
<Button variant="clear" onClick={onClose} className="min-w-[80px] h-[36px] text-sm">닫기</Button>
