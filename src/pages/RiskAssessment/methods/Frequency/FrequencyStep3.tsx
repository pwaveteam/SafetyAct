...
<Button variant="step" onClick={() => navigate("/risk-assessment/methods/frequency/step2")}><ChevronLeft size={18} className="mr-2" />이전으로</Button>
<Button variant="step" onClick={() => {
