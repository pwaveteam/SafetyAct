...
<Button variant="step" onClick={() => navigate("/risk-assessment/methods/frequency/step1")}><ChevronLeft size={18} className="mr-2" />이전으로</Button>
<Button variant="step" onClick={() => navigate("/risk-assessment/methods/frequency/step3")}>저장 후 다음으로<ChevronRight size={18} className="ml-2" /></Button>
</div>
</section>
)
}