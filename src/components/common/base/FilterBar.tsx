...
keyword, onKeywordChange, searchText, onSearchText,
educationTarget, onEducationTargetChange,
educationMethod, onEducationMethodChange,
onSearch
}) => (
...
{renderSelect("교육방식", educationMethod, onEducationMethodChange, methodOptions)}
</div>
)}
