...
<thead>
<tr className="h-[33px]" style={{ background: "#F7F8FA", borderTop: "1.9px solid #161616", borderBottom: "1px solid #CCCCCC" }}>
{columns.map((col, idx) => (
...
{col.renderCell ? col.renderCell(row, col, rowIdx) : row[col.key]}
</td>
))}
</tr>
))}
